...
setInjectRuns(tier0Config, [ 273424, 273446, 274968, 276357, 278808, 301524, 302159, 302661, 304120 ])
...
defaultRecoTimeout =  48 * 3600 * 100
...
setScramArch(tier0Config, "CMSSW_9_2_14_patch2", "slc6_amd64_gcc530")
...
defaultProcVersion = 6
expressProcVersion = 6
alcarawProcVersion = 6
